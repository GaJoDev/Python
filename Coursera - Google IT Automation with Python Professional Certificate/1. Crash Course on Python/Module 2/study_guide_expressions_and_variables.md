...
- __expression__ - a combination of numbers, symbols, or other values that produce a result when evaluated

- __data types__ - classes of data (e.g., string, int, float, Boolean, etc.), which include the properties and behaviors of instances of the data type (variables)

- __variable__ - an instance of a data type class, represented by a unique name within the code, that stores changeable values of the specific data type

- __implicit conversion__ - when the Python interpreter automatically converts one data type to another

- __explicit conversion__ - when code is written to manually convert one data type to another using a data type conversion function:
